...
class App(ctk.CTk):
    ...
    def init_parameters(self):
        ...
        self.color_vars={
           'brightness': ctk.DoubleVar(value=BRIGHNESS_DEFAULT),
    ...
    def manipulate_image(self,*args):
        ...
        #brightness & vibrance
        if self.color_vars['brightness'].get() != BRIGHNESS_DEFAULT:
        ...
        if self.color_vars['vibrance'].get() != VIBRANCE_DEFAULT:
            vibrance_enchancer=ImageEnhance.Color(self.image)
            self.image=vibrance_enchancer.enhance(self.color_vars['vibrance'].get())
